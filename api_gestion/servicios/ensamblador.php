...
require_once __DIR__ . '/ServicioPrograma.php';
require_once __DIR__ . '/../repositorios/RepositorioProgramaMariaDB.php';
...
function crearServicioPrograma(): IServicioPrograma
{
    ...
    // Los valores por defecto apuntan a localhost:13331, que es el puerto
    ...
    $repositorio = new RepositorioProgramaMariaDB(
        getenv('DB_DSN')     ?: 'mysql:host=localhost;port=13331;dbname=gestion_php_local',
        getenv('DB_USUARIO') ?: 'gestion',
