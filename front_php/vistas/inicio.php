...
<div class="p-4 p-md-5 mb-4 bg-white border rounded-3 shadow-sm">
  <h1 class="display-6 fw-semibold">Sistema de gestión profesoral</h1>
  <p class="fs-5 text-body-secondary mb-0">
    Los programas académicos de los que dependen los docentes.
  </p>
</div>
...
<div class="row g-3">
  <div class="col-md-6">
    <div class="card h-100 shadow-sm">
      <div class="card-body">
        <h2 class="card-title h5">Programas</h2>
        <p class="card-text text-body-secondary">
          11 datos por ficha. Se pueden agregar, corregir y retirar.
