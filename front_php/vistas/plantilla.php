...
<head>
  ...
  <title>Gestión profesoral</title>
  ...
  <nav class="navbar navbar-expand navbar-dark bg-dark">
    <div class="container">
      ...
      <ul class="navbar-nav ms-auto">
        ...
        <li class="nav-item">
          <a class="nav-link <?= str_starts_with($ruta, '/programas') ? 'active' : '' ?>"
  ...
  <footer class="border-top bg-white py-3">
    <div class="container">
      <p class="text-body-secondary small mb-0">
        Módulo de gestión profesoral — ejemplo del curso ·
        versión 1: <code>programa</code> de punta a punta, en PHP
      </p>
    </div>
  </footer>
