# Constitución del proyecto — Módulo de Gestión profesoral, en PHP
...
Este repositorio construye el módulo de **Gestión profesoral** del proyecto de
aula, en **PHP puro sobre MariaDB**. Su gemelo,
[`proyecto_paradigmas_gestion_profesoral1`](../../../proyecto_paradigmas_gestion_profesoral1), construye el
...
| Puertos | front **8112** · API **8113** · MariaDB **13331** · phpMyAdmin **8106** | otros |
...
`require_once __DIR__ . '/../api_gestion/modelos/Programa.php'` para usar
...
- El servicio depende de `IRepositorioPrograma`, **la interfaz**, nunca
...
(`ProyectosDeAula/db_scripts/mysql/gestion_profesoral.sql`). Este proyecto
...
| Interfaces | `I` delante: `IServicioPrograma` |
...
Una ruta por recurso: `/api/programa`. **No** existe ni existirá
...
Lo mismo del lado del front: `listar_gestion()`, no `listar($tabla)`.
