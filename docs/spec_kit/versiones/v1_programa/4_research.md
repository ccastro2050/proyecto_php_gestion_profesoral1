# Investigación y decisiones — v1: `programa` (PHP)
...
**Contexto.** El mismo módulo existe en `proyecto_paradigmas_gestion_profesoral1`,
sobre PostgreSQL.
...
1. **El script que el curso entrega para este módulo es MySQL**:
   `ProyectosDeAula/db_scripts/mysql/gestion_profesoral.sql`, y el modelo
...
**Contexto.** La ficha tiene 11 campos.

**Decisión.** El listado muestra 6 columnas
