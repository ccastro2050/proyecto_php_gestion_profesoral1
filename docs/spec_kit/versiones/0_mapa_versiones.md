# Mapa de versiones — Módulo de Gestión profesoral (PHP)
...
|---|---|---|
| **v1** | `programa` de punta a punta: los 5 verbos, el borrado lógico, la pantalla y la prueba de capas | **hecha** |
...
## Por qué la v1 es `programa`

De las tablas **sin clave foránea** del módulo, es la que más enseña:

- tiene **11 columnas** —suficientes para que el
...
- su llave es `id`, un entero:
  la conversión de la URL a entero pasa en el enrutador, y `(int) "abc"` da 0, que el servicio rechaza con 400;
- y arranca **con 191 filas**, así que la pantalla tiene qué
...
[`proyecto_paradigmas_gestion_profesoral1`](../../../../proyecto_paradigmas_gestion_profesoral1) construye esta
