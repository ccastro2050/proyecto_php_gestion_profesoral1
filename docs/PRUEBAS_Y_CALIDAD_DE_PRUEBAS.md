...
`api_gestion/pruebas/prueba_capas.php`:
...
| **Prueba de capas** | `api_gestion/pruebas/` | Que las reglas funcionen **y** que las capas estén cortadas |
...
10. En este repositorio: los criterios de `2_spec.md`, el smoke de
    `7_quickstart.md` y la prueba de capas de `api_gestion/pruebas/` — la
